...
#┌─────────────────────────────────
#│ JOYFUL NOTE : admin.cgi - 2014/01/05
#│ Copyright (c) KentWeb
...
EOM
	...
	while (<IN>) {
		...
		print qq|<b>$sub</b> 名前：<b>$name</b> 日時：$date\n|;
		if ($ex) {
...
<style type="text/css">
<!--
body,td,th { font-size:80%; background:#fef5da; }
...
dl.log dt { border-top:1px dashed #666; margin:10px 0 5px 0; padding:4px; }
-->
</style>
<title>$ttl</title>
</head>
