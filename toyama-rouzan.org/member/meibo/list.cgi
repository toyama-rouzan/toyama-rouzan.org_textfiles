...
@show=(1,2,3,4);	# ←初期設定だと項目1と6と5の順に、左から表示されます

# ↑で指定した各項目の幅（width=○○の部分)。
@width=(200,60,60,200);	# ←初期設定だと項目1が280、項目5と6が50
...
$lim[1] = 50;		# 項目1を50文字に制限。次の行以下にどんどん追加できます。
$lim[4] = 50;		# 備考欄
...
if($modoru){ print"　[<A HREF=\"$modoru\">会員専用メニューに戻る</A>]\n"; }
