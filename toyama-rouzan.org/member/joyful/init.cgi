...
#LINE トークルーム通知機能 2021/07/04 yoshioka
# → 0=no  1=yes
$cf{line_notify} = 1;

#2025/04以降はLINE Notifyが廃止されるため、{line_token1}は未定義にして、
#{line_business_account_access_token}にアクセストークンを、{line_groupid1}にLINEトークルームのグループIDを定義する

#LINE トークルームのアクセストークン
#$cf{line_token1} = "1h073TNY63u245Qouu3YeJXC8rSppM3bjOhCtSlAkPv"; #第一実験室
#$cf{line_token1} = "bYis704Vh9yBfyuPMQf2ks6NUqb835N9u2YnRMKSVRF"; #おむすび会

# LINE公式アカウントのアクセストークン 
# AccessToken:富山勤労者山岳会 事務局 
# 2024/12/28 なぜかERROR:429(レートリミット超過)で送信できなくなったので、暫定で「富山勤労者山岳会 イベント案内」から送信する
# 2024/12/30 LINEのトークルームへの送信メッセージ数の計算方法が(メッセージ数*トークルームのメンバー数)だとわかった
#            だから39人のトークルームにメッセージを6件送っただけで管理画面の送信済みメッセージ数が上限の200を超えてしまっていた
#            LINE Notifyサービス終了の2025/03/31までは従来通りLINE Notifyを使い、それ以降はトークルーム通知をあきらめるか、まったく違う手を考えることにする
#$cf{line_business_account_access_token} = '3y5GFJZdOZOcPrDFT7FV02cx14XDBm9/GoDV9qKmE3QKSVt+Mat5BDbPZdUQbLzDQWlTxMc/MGwkkKcNdITWxhhPzhu57GsoxG4ia4qu7hvMAvtMpNV4wkg3yBAb+DFPuKSrDs5t36SP7o9CdHD9rwdB04t89/1O/w1cDnyilFU=';

# AccessToken:富山勤労者山岳会 イベント案内
$cf{line_business_account_access_token} = 'NFR4a4n1jRObTVpKbHs+WXbmETIdDJkprbAU2jVSKXjXCAPZ4dpU8W6Rxon9kwyxzLljyIWBVtFGDpC/wssxYr2KqcCa05c7j7bE0Vne34WvASNembW41KS44uWg2X43UXZ4uhdupyjs/oa6u8ybzAdB04t89/1O/w1cDnyilFU=';

# LINEのトークルームID
#GroupID:富山労山おむすび会
$cf{line_groupid1} = 'C5a2397090383e4bd01a4098bf3139622';
